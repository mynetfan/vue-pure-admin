import{b7 as H,y as d,bd as X,b6 as Y,Z as O,aR as ee,be as te,H as ne,av as y,bf as z,K as E,bg as oe,b0 as I,bh as ae,aP as ue,z as le,c as L,j as A,h as b,r as N}from"./index-9df66b72.js";import{u as re}from"./app-a836bbc7.js";import{u as T}from"./epTheme-515056f1.js";function se(){const{$storage:t,$config:e}=H(),o=()=>{X().multiTagsCache&&(!t.tags||t.tags.length===0)&&(t.tags=Y),t.locale||(t.locale={locale:(e==null?void 0:e.Locale)??"zh"},O().locale.value=(e==null?void 0:e.Locale)??"zh"),t.layout||(t.layout={layout:(e==null?void 0:e.Layout)??"vertical",theme:(e==null?void 0:e.Theme)??"default",darkMode:(e==null?void 0:e.DarkMode)??!1,sidebarStatus:(e==null?void 0:e.SidebarStatus)??!0,epThemeColor:(e==null?void 0:e.EpThemeColor)??"#409EFF"}),t.configure||(t.configure={grey:(e==null?void 0:e.Grey)??!1,weak:(e==null?void 0:e.Weak)??!1,hideTabs:(e==null?void 0:e.HideTabs)??!1,showLogo:(e==null?void 0:e.ShowLogo)??!0,showModel:(e==null?void 0:e.ShowModel)??"smart",multiTagsCache:(e==null?void 0:e.MultiTagsCache)??!1})},n=d(()=>t==null?void 0:t.layout.layout),u=d(()=>t.layout);return{layout:n,layoutTheme:u,initStorage:o}}const P="当前路由配置不正确，请检查配置";function fe(){var S;const t=re(),e=ee().options.routes,{wholeMenus:o}=te(ne()),n=((S=y())==null?void 0:S.TooltipEffect)??"light",u=d(()=>({width:"100%",display:"flex",alignItems:"center",justifyContent:"space-between",overflow:"hidden"})),s=d(()=>{var a;return(a=z())==null?void 0:a.username}),c=d(()=>(a,f)=>({background:a===f?T().epThemeColor:"",color:a===f?"#f4f4f5":"#000"})),h=d(()=>(a,f)=>a===f?"":"dark:hover:!text-primary"),i=d(()=>s.value?{marginRight:"10px"}:""),C=d(()=>!t.getSidebarStatus),$=d(()=>t.getDevice),{$storage:l,$config:r}=H(),m=d(()=>{var a;return(a=l==null?void 0:l.layout)==null?void 0:a.layout}),M=d(()=>r.Title);function B(a){const f=y().Title;f?document.title=`${E(a.title)} | ${f}`:document.title=E(a.title)}function G(){z().logOut()}function Q(){oe.push("/welcome")}function W(){I.emit("openPanel")}function K(){t.toggleSideBar()}function U(a){a==null||a.handleResize()}function Z(a){var p;if(!a.children)return console.error(P);const f=/^http(s?):\/\//,g=(p=a.children[0])==null?void 0:p.path;return f.test(g)?a.path+"/"+g:g}function q(a,f){if(o.value.length===0||J(a))return;let g="";const p=a.lastIndexOf("/");p>0&&(g=a.slice(0,p));function k(w,_){return _?_.map(v=>{v.path===w?v.redirect?k(v.redirect,v.children):I.emit("changLayoutRoute",{indexPath:w,parentPath:g}):v.children&&k(w,v.children)}):console.error(P)}k(a,f)}function J(a){return ae.includes(a)}return{title:M,device:$,layout:m,logout:G,routers:e,$storage:l,backHome:Q,onPanel:W,getDivStyle:u,changeTitle:B,toggleSideBar:K,menuSelect:q,handleResize:U,resolvePath:Z,isCollapse:C,pureApp:t,username:s,avatarsStyle:i,tooltipEffect:n,getDropdownItemStyle:c,getDropdownItemClass:h}}function _e(t){const{$storage:e,changeTitle:o,handleResize:n}=fe(),{locale:u,t:s}=O(),c=ue();function h(){e.locale={locale:"zh"},u.value="zh",t&&n(t.value)}function i(){e.locale={locale:"en"},u.value="en",t&&n(t.value)}return le(()=>u.value,()=>{o(c.meta)}),{t:s,route:c,locale:u,translationCh:h,translationEn:i}}const de={xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em","aria-hidden":"true",class:"globalization",viewBox:"0 0 512 512"},ce=b("path",{fill:"currentColor",d:"m478.33 433.6-90-218a22 22 0 0 0-40.67 0l-90 218a22 22 0 1 0 40.67 16.79L316.66 406h102.67l18.33 44.39A22 22 0 0 0 458 464a22 22 0 0 0 20.32-30.4zM334.83 362 368 281.65 401.17 362zm-66.99-19.08a22 22 0 0 0-4.89-30.7c-.2-.15-15-11.13-36.49-34.73 39.65-53.68 62.11-114.75 71.27-143.49H330a22 22 0 0 0 0-44H214V70a22 22 0 0 0-44 0v20H54a22 22 0 0 0 0 44h197.25c-9.52 26.95-27.05 69.5-53.79 108.36-31.41-41.68-43.08-68.65-43.17-68.87a22 22 0 0 0-40.58 17c.58 1.38 14.55 34.23 52.86 83.93.92 1.19 1.83 2.35 2.74 3.51-39.24 44.35-77.74 71.86-93.85 80.74a22 22 0 1 0 21.07 38.63c2.16-1.18 48.6-26.89 101.63-85.59 22.52 24.08 38 35.44 38.93 36.1a22 22 0 0 0 30.75-4.9z"},null,-1),ie=[ce];function me(t,e){return L(),A("svg",de,ie)}const ze={render:me},x={outputDir:"",defaultScopeName:"",includeStyleWithColors:[],extract:!0,themeLinkTagId:"theme-link-tag",themeLinkTagInjectTo:"head",removeCssScopeName:!1,customThemeCssFileName:null,arbitraryMode:!1,defaultPrimaryColor:"",customThemeOutputPath:"/home/runner/work/vue-pure-admin/vue-pure-admin/node_modules/.pnpm/@pureadmin+theme@3.0.0/node_modules/@pureadmin/theme/setCustomTheme.js",styleTagId:"custom-theme-tagid",InjectDefaultStyleTagToHtml:!0,hueDiffControls:{low:0,high:0},multipleScopeVars:[{scopeName:"layout-theme-default",varsContent:`
